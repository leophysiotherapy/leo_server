...
-- AddForeignKey
ALTER TABLE "_appointmentToservices" ADD CONSTRAINT "_appointmentToservices_B_fkey" FOREIGN KEY ("B") REFERENCES "services"("serviceID") ON DELETE CASCADE ON UPDATE CASCADE;
